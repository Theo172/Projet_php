...
include_once '_view-locations.php';
...
<main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ps ps--active-y">
    <div class="container">
        ...
        <div class="card m-4 p-4">
            ...
            <hr>
            <p class="text-bold">Adesse :</p>
            <p><?php echo $location['adress']; ?></p>
            <hr>
            <a class="btn btn-success col-2" href="single-location.php?id=<?php echo $location['location_id']; ?>">
                <?php echo $location['price']; ?>€</a>
            <a href="edit-products.php?id=<?php echo $location['location_id']; ?>"
                class="btn btn-warning col-2">Modifier
                le bien</a>
        </div>
        <?php
        }
